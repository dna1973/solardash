...
10. "lighting_cost": Valor da Iluminação Pública / CIP / COSIP. Procure pela linha "Ilum. Púb. Municipal" ou "CIP" ou "COSIP" nos ITENS DA FATURA. ATENÇÃO: nas faturas Neoenergia, essa linha contém VÁRIOS valores misturados (ICMS, base de cálculo, tributos). O valor correto da iluminação pública é o PRIMEIRO valor numérico que aparece LOGO APÓS o texto "Ilum. Púb. Municipal" — geralmente na coluna VALOR ou próxima. NÃO confunda com valores de ICMS, base de cálculo ICMS, ou outros tributos que aparecem na mesma linha. No exemplo "Ilum. Púb. Municipal 148,06 ICMS 653,40 20,50 133,94", o lighting_cost é 148,06.
