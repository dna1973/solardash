...
9. "gross_value": Valor bruto. REGRA DE CÁLCULO OBRIGATÓRIA: gross_value = net_value + deductions_value. Ou seja, pegue o TOTAL A PAGAR (net_value) e some com o total de deduções (deductions_value). Exemplo: se net_value=3575.53 e deductions_value=224.26, então gross_value=3799.79. NÃO tente somar itens individuais da tabela — use sempre esta fórmula.
