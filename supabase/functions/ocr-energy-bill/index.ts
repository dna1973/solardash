...
9. "gross_value": Valor bruto — soma de TODOS os itens positivos da coluna "VALOR COM TRIB.(R$)" na tabela de itens da fatura, incluindo Consumo-TUSD, Consumo-TE, Demanda, ICMS-CDE e quaisquer outras linhas com valor positivo (excluindo APENAS deduções/descontos negativos e iluminação pública). VALIDAÇÃO: gross_value deve ser aproximadamente igual a net_value + deductions_value.
10. "lighting_cost": Valor da Iluminação Pública / CIP / COSIP. Procure pela linha "Ilum. Púb. Municipal" ou "CIP" ou "COSIP" nos ITENS DA FATURA. ATENÇÃO CRÍTICA: Na tabela de itens da fatura Neoenergia, a linha "Ilum. Púb. Municipal" NÃO tem unidade (kWh) nem preço unitário — ela tem apenas um VALOR na coluna de valor. Esse valor é o lighting_cost. CUIDADO: NÃO confunda com valores PIS/COFINS de outras linhas (como Consumo-TUSD ou Consumo-TE) que aparecem em colunas adjacentes. O valor de iluminação pública costuma ser um número significativo (dezenas a centenas de reais). Exemplos reais: "Ilum. Púb. Municipal 1.649,58" → lighting_cost = 1649.58; "Ilum. Púb. Municipal 148,06" → lighting_cost = 148.06; "Ilum. Púb. Municipal 73,52" → lighting_cost = 73.52. Se após "Ilum. Púb. Municipal" aparecer "ICMS", o valor ANTES de "ICMS" é o lighting_cost. Se a linha de Iluminação Pública não existir na fatura, use 0.
