    ...
    <Card>
      <CardHeader>
        ...
        <p className="text-xs text-muted-foreground">
          Associe cada código de cliente a um nome de local e a uma usina. Ao importar faturas, o sistema usará esta tabela automaticamente.
        </p>
      </CardHeader>
            ...
            <TableRow>
              ...
              <TableCell>
                <Select value={newNomPlant || "none"} onValueChange={(v) => setNewNomPlant(v === "none" ? null : v)}>
                  <SelectTrigger className="h-8 text-xs">
                    <SelectValue placeholder="Selecione usina" />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="none">Nenhuma</SelectItem>
                    {plants.map((p) => (
              ...
              <TableCell className="text-right">
                <Button
                  ...
                  onClick={() => saveNomenclature(newNomAccount, newNomLocation, newNomPlant)}
